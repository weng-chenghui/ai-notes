...
\begin{itemize}
  \item \((U,V)\in\mathbb{T}_5\): the \emph{private input} (a point on the discrete torus).
  ...
  \item \(K=p_5(U,V)\in\mathbb{K}_5\): the \emph{observed output} (a point on the discrete Klein bottle); this is what Alice sees.
\end{itemize}
