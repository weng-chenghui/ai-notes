...
**Author Response:** Added `references.bib` with foundational sources (category theory and quantum channels, plus a general information theory reference) and added a minimal citation in the abstract. Added a short “Citation note” in the introduction and included a bibliography at the end of the document.  
**Status:** Resolved
...
**Author Response:** Confirmed that references in the current document use labeled figures/sections (where present) and that compilation resolves cross-references cleanly.  
**Status:** Resolved
## Status
- [ ] Ready to merge
- [x] Requires changes
